...
function env.onload(...)
    ...
    if env.set and env.set.init then
        ...
        env.set.init("Status",console:getScreenWidth()==console:getBufferWidth() and 'on' or 'off',env.set_title,"core","Display the status bar","on,off")
    ...
    if  env.ansi and env.ansi.define_color then
        ...
        env.ansi.define_color("commandcolor","CYN","ansi.core","Define command line's color, type 'ansi' for more available options")
