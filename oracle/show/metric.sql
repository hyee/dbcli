/*[[
    Show the per-second database metrics of the last 10 minutes, taken from the
    gv$xxxmetric views. Usage: @@NAME [-h]

    -h : Read the gv$xxxmetric_history views instead of the gv$xxxmetric views
