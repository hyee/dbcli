...
print(fmt:format('PageCache',
                 mb(mem_('Active(file)',0)+mem_('Inactive(file)',0)),
                 mb('Active(file)',0),
                 mb('Inactive(file)'),
                 mb(mem_('Active(file)',0)+mem_('Inactive(file)',0)),
                 mb(mem_('Active(file)',0)+mem_('Inactive(file)',0)),
...
print(fmt:format('Anon',
                 mb(mem_('Active(anon)',0)+mem_('Inactive(anon)',0)),
                 mb('Active(anon)',0),
                 mb('Inactive(anon)',0),
                 mb(mem_('Active(anon)',0)+mem_('Inactive(anon)',0)),
                 '',
...
print(fmt:format('Shared',
                 mb('Shmem'),
                 mb(mem_('Shmem',0)-(mem_('KReclaimable') or mem('SReclaimable'))+mem_('SReclaimable')),
                 '',
                 mb((mem_('KReclaimable') or mem('SReclaimable'))-mem_('SReclaimable',0)),
