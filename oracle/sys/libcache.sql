/*[[This script needs SYS access to find out who are pinning the target object. Usage: libcache <PIN|KEPT|object_name>]]*/
SELECT *
FROM   (SELECT kglnaown owner,
               ...
               decode(bitand(kglobflg, 3),
                      ...
                      decode(kglobtyp,
                             ...
                             'INDEX SUBPARTITION',
                             36,
                             'REPLICATED TABLE OBJECT',
                             37,
                             'REPLICATION INTERNAL PACKAGE',
                             38,
                             'CONTEXT POLICY',
                             39,
                             'PUB_SUB',
