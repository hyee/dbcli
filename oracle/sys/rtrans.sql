...
PRO ==========================
SELECT s.sid||','||s.serial#||',@'||s.inst_id sid,s.username,
       ...
       -- additional columns:
      --, g.k2gtitid_ora AS globalid_ora, g.K2GTITID_EXT GLOBALID, g.K2GTIBID BRANCHID
FROM   SYS.X$K2GTE2 g, gv$session s
