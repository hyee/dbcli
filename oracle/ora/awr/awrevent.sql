...
SELECT inst, '- * ON CPU *' event,null wait_class,max(cpu_count) counts,null timeouts,sum(value*flag)* 1e-6/&avg waited,
       ...
       &ver1 ,null "<1us",null "<2us",null "<4us",null "<8us",null "<16us",null "<32us",null "<64us",null "<128us",null "<256us",null "<512us",null "<1ms",null "<2ms",null "<4ms",null "<8ms",null "<16ms",null "<33ms",null "<66ms",null "<131ms",null "<262ms",null "<524ms",null "<1s",null "<2s",null "<4s",null "<8s",null "<17s",null "<34s",null "<1m",null ">=1m"
from   time_model a 
