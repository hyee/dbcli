...
BEGIN
    :awr$sqlstat:=q'[
       (SELECT --+merge leading(s) use_hash(s h)
               ...
               decode(elapsed_time_delta, 0, disk_reads_total, disk_reads_delta)*8/1024 disk_reads,
               decode(elapsed_time_delta, 0, buffer_gets_total, buffer_gets_delta)*8/1024 buffer_gets,
               decode(elapsed_time_delta, 0, direct_writes_total, direct_writes_delta)*8/1024 direct_writes,
