...
--------------------------------------------------------------------------------
--
--   The Session Snapper v4.11 BETA ( USE AT YOUR OWN RISK !!! )
...
begin
    ...
    if pagesize > 0 then
        output(' ');
        output('-- Session Snapper v4.11 BETA - by Tanel Poder ( http://blog.tanelpoder.com ) - Enjoy the Most Advanced Oracle Troubleshooting Script on the Planet! :)');
        output(' ');
    end if;
