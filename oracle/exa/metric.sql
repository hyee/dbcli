...
COL "OFL_IN,OFL_OUT,SI_SAVE,PASSTHRU,FC_R,HD_R,BOTH,OFL_IN/s,OFL_OUT/s,SI_SAVE/s,PASSTHRU/s,PASSTHRU_CPU,PASSTHRU_CPU/s,FC_R/s,HD_R/s,BOTH/s,FC_W,HD_W,FC_W/s,HD_W/s" for kmg
...
BEGIN
    ...
    OPEN :flashcache FOR 
        ...
        FOR    NAME IN('FC_BY_ALLOCATED' "ALLOC",
                       ...
                       'FC_IO_BY_R_SEC' "R/s",
                       'FC_IO_BY_W_SEC' "W/s",
                       'FC_IO_BY_R_SKIP_FC_THROTTLE_SEC' "THROT/s",
