...
echo =========================
del /F/S/Q ".\src\java"
XCOPY /E /Y "d:\JavaProjects\jline3.29\dbcli\src\*" .\src\java
XCOPY /E /Y "d:\JavaProjects\jline3.29\opencsv\src\*" "%GIT_HOME%\opencsv\src"
XCOPY /E /Y "d:\JavaProjects\jline3.29\nuprocess\src\*" "%GIT_HOME%\nuprocess\src"
