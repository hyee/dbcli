...
public class NuProcessBuilder {
    ...
    public NuProcessBuilder(List<String> commands, Map<String, String> environment) {
        ...
        this.environment = environment == null ? null : new TreeMap<String, String>(environment);
    ...
    public NuProcess start() {
        ...
        if (environment == null) return factory.createProcess(command, null, processListener, cwd);
