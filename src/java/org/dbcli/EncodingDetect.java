...
public class EncodingDetect extends Encoding {
     ...
     * highest probability is returned.
     */
    public int detectEncoding(byte[] rawtext) throws Exception {
        int[] scores;
        ...
        if (rawtext.length > 3) {
            ...
            final int b1 = rawtext[0] & 0xFF;
            final int b2 = rawtext[1] & 0xFF;
            final int b3 = rawtext[2] & 0xFF;
            final int b4 = rawtext[3] & 0xFF;

            switch (b1) {
                case 0xEF:
                    if (b2 == 0xBB && b3 == 0xBF) return UTF8;
                    break;
                case 0xFE:
                    if (b2 == 0xFF && b3 == 0x00 && b4 == 0x00) {
                        return X_ISO_10646_UCS_4_3412;
                    } else if (b2 == 0xFF) {
                        return UTF_16BE;
                    }
                    break;
    ...
    public String getEncoding(byte[] rawtext) throws Exception {
...
class Encoding {
    ...
    public static int X_ISO_10646_UCS_4_3412 = 24;
    public static int X_ISO_10646_UCS_4_2143 = 25;
    public static int UTF_32BE = 26;
    public static int UTF_32LE = 27;
    public static int UTF_16BE = 28;
    public static int UTF_16LE = 29;
    public static int BIG5P = 30;
    public static int TOTALTYPES = 31;
